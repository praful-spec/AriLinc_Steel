      ...
      <div style={{width:"100%",maxWidth:400}}>
        ...
        <div style={{background:"rgba(255,255,255,0.08)",backdropFilter:"blur(20px)",borderRadius:20,padding:"32px",border:"1px solid rgba(255,255,255,0.15)",boxShadow:"0 24px 64px rgba(0,0,0,0.4)"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:14}}>
            ...
            <div><label style={lbl}>Company *</label><input style={inp("company")} value={form.company} onChange={set("company")} placeholder="Steel Works / Rolling Mill"/>{errors.company&&<div style={{fontSize:11,color:"#fca5a5",marginTop:3}}>{errors.company}</div>}</div>
